...
#######################################################################################################
#################################### Run together with SparCC ########################################
#######################################################################################################

git.folder<- "/home/didac/Desktop/microbiome_analysis/Machine-learning-of-microbial-interaction/"
...
partial.tabs<- lapply(c(2,3,5), function(x){ read.table(paste0("table-str", i, ".txt"))})
...
```{r FastSpar run, eval=FALSE, engine='bash', message=FALSE, echo=FALSE, include=FALSE}
#!/bin/bash
...
```{r prepare_Progol, warning=FALSE, message=FALSE, echo=FALSE, eval=FALSE}
###################################################################
...
```{r run_Progol, eval=FALSE, engine='bash'}
#!/bin/bash
OTU_VEC=($OTU_VEC2 $OTU_VEC3 $OTU_VEC5)
